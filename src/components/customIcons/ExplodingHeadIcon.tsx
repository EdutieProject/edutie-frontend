 ...
 */
export default function ExplodingHeadIcon(params: CustomIconProps) {
    return (
        <SvgIcon sx={{color: params.color, height: params.height, width: params.width}} htmlColor={params.color}>
            <svg viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path opacity="0.503384" d="M186.163 160.13C169.151 166.114 153.774 160.036 144.551 153.547C141.069 151.097 122.337 172.472 107.1 153.547C82.8435 123.42 117.262 77.4495 154.954 77.4495C162.796 77.4495 164.984 45.9185 199.34 42.3311C238.731 38.2179 240.427 73.7911 245.808 73.7911C249.66 73.7911 269.015 56.5109 288.065 74.7816C328.285 113.356 268.369 130.564 268.693 131.594C270.689 137.908 288.78 133.693 291.58 144.034C298.859 170.908 242.315 162.622 231.242 154.278" stroke="#000000" stroke-opacity="0.9" stroke-width="14" stroke-linecap="round" stroke-linejoin="round"/>
                <path opacity="0.503384" d="M195.694 175.227C197.897 189.779 193.254 224.238 192.051 226.637" stroke="#000000" stroke-opacity="0.9" stroke-width="14" stroke-linecap="round" stroke-linejoin="round"/>
                <path opacity="0.503384" d="M220.133 172.472C215.721 191.104 220.75 210.21 220.75 228.473" stroke="#000000" stroke-opacity="0.9" stroke-width="14" stroke-linecap="round" stroke-linejoin="round"/>
                <path opacity="0.503384" d="M234.29 181.441C331.937 207.711 69.7553 214.031 181.698 183.326" stroke="#000000" stroke-opacity="0.9" stroke-width="14" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
        </SvgIcon>
    );
}